...
function getVehiclesCostInCreditsSumTotal(character) {
  ...
  return character.vehicles.reduce(
    (total, ships) => total + ships.cost_in_credits,
    0
  );
}
...
function getStarshipPassengerAndCrewSumTotal(character) {
  // TODO: Add your code here.
  return (
    character.starships.reduce((a, b) => a + b.passengers, 0) +
    character.starships.reduce((a, b) => a + b.crew, 0)
  );
}
...
function getCargoCapacityTotal(character) {
  // TODO: Add your code here.
  const starshipCargo = character.starships.reduce(
    (a, b) => (a += b.cargo_capacity),
    0
  );
  const vehicleCargo = character.vehicles.reduce(
    (a, b) => (a += b.cargo_capacity),
    0
  );
...
function getLargestCargoStarshipModelName(character) {
  // TODO: Add your code here.
  if (character.starships === undefined) {
    return `none`;
  } else {
  }
}
